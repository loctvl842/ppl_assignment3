...
member
    : mutable_attribute_decl
    | immutable_attribute_decl
    | method_decl
    ;
...
mutable_attribute_decl
    : STATIC? attribute_type attribute_names SEMI
    ;

immutable_attribute_decl
    : (STATIC? FINAL | FINAL STATIC?) attribute_type attribute_names SEMI
    ;

attribute_type
    : INT | FLOAT | BOOLEAN | STRING | array_type | ID
    ;
...
normal_method
    : STATIC? return_type ID LB params? RB block_stmt
    ;

main_method
    : VOID 'main' LB RB block_stmt
    ;
...
return_type
    : INT | FLOAT | BOOLEAN | STRING | VOID | ID | array_type
    ;

params
    : (param SEMI params | param)
    ;

param
    : param_type comma_sep_ids
    ;
...
comma_sep_array_elmts
    : (elmt COMMA comma_sep_array_elmts | elmt)
    ;
...
/* Array Type */
array_type
    : (INT | FLOAT | BOOLEAN | STRING | ID) LSB INT_LIT RSB
    ;
...
var_decl
    : FINAL? attribute_type attribute_names SEMI
    ;
